...
target "ordinov_laravel_php73_nonode_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php73-nonode-build1.3.Dockerfile"
...
target "ordinov_laravel_php74_nonode_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php74-nonode-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php80_nonode_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php80-nonode-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php81_nonode_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php81-nonode-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php82_nonode_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php82-nonode-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php83_nonode_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php83-nonode-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php81_node14_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php81-node14-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php81_node16_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php81-node16-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php81_node18_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php81-node18-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php81_node20_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php81-node20-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php82_node14_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php82-node14-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php82_node16_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php82-node16-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php82_node18_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php82-node18-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php82_node20_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php82-node20-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php83_node16_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php83-node16-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php83_node18_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php83-node18-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php83_node20_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php83-node20-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php73_node14_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php73-node14-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php73_node16_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php73-node16-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php73_node18_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php73-node18-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php73_node20_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php73-node20-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php74_node14_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php74-node14-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php74_node16_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php74-node16-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php74_node18_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php74-node18-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php74_node20_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php74-node20-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php80_node14_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php80-node14-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php80_node16_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php80-node16-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php80_node18_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php80-node18-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
...
target "ordinov_laravel_php80_node20_build1_3" {
  context = "."
  dockerfile = "./dist/20250930223401/php80-node20-build1.3.Dockerfile"
  platforms = ["linux/amd64","linux/arm64","linux/arm/v7"]
